            ...
            <div class="col-4">
                <div class="card mx-1 my-1" style="width: auto;">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal2"><img src="{{ asset('assets/images/update.png') }}" alt="" style="width : 20px"></button>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal"><img src="{{ asset('assets/images/delete.png') }}" alt="" style="width : 20px"></button>
                        <img src="{{ asset('assets/images/like.png') }}" alt="" style="width : 20px">10   
                    </div>
                </div>
            </div>
        @endfor
